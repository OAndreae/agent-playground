...
1. **Input** - You provide three pieces of information:
   - Guest speaker's name
   - Brief description of their background or achievements
   - Profile of your podcast's audience

2. **AI Research** - Our AI agent conducts real-time web research, performing targeted searches to find relevant information about the guest, their work, recent accomplishments, and industry context.

3. **Preparation Generation** - The platform synthesises this research into a structured interview prep report that includes:
   - Executive summary of the guest's background and key accomplishments
   - Talking points strategically tailored to your audience
   - Thoughtfully crafted interview questions
   - Cited sources with links for further exploration

4. **Real-time Delivery** - Results stream to your screen as the AI researches, so you can see progress in real-time and begin reading preparation notes immediately.

**Q: How long does it take to generate preparation materials?**

A: The entire process typically takes 1-3 minutes, depending on the availability of information about the guest and the complexity of your audience profile. Results stream in real-time, so you can begin reviewing preparation notes as they're generated.
...
**Q: How does the platform tailor content to my specific podcast audience?**

A: You provide an audience profile describing your listenerstheir interests, industry, sophistication level, and what they care about. The AI uses this profile to generate talking points and questions that resonate with your specific community. For example, a business podcast's audience might care about entrepreneurial insights and market strategy, while a technology podcast's audience might focus on technical innovation and market trends. The platform adapts its output accordingly.

**Q: Can I update my audience profile over time?**

A: Absolutely. Your audience profile lives in the platform, so you can update it anytime to reflect shifts in your listener base or podcast focus. All subsequent research will incorporate your updated profile.
...
A: Yes. All preparation materials are available in markdown format and can be easily copied, exported, or shared with co-hosts, producers, or guests. You can also share the prepared notes with your team for collaborative preparation.

---

### Privacy and Data

**Q: What happens to the guest information I provide?**

A: Guest information is used solely to conduct research for your interview preparation. We do not store guest information after your research session concludes, nor do we use it to train AI models or share it with third parties. Your podcast audience profile is stored to enable personalisation across multiple research sessions.

**Q: Is my podcast audience information secure?**

A: Yes. Audience profile data is encrypted and stored securely. You maintain full control over this information and can delete or update it at any time.
...
- **Real-time sourcing** - Uses current web data to surface recent accomplishments, news, and context.
...
- **Limited to publicly available information** - If your guest has minimal online presence, results will be constrained.
- **Requires audience clarity** - The better you describe your audience, the better the output. Vague audience profiles yield more generic results.
- **AI reasoning limitations** - While the AI is powerful, it can occasionally misinterpret context or surface less relevant information. Always review and use your editorial judgment.
- **Real-time sources only** - The platform researches current, publicly available information. It cannot access paywalled content or private databases.

**Q: What's on the roadmap?**

A: We're excited about several future directions:

- **Multi-guest interviews** - Support for researching and comparing multiple guests simultaneously.
- **Historical analysis** - Long-form guest profiles that track a guest's evolution over time.
- **Competitive positioning** - Identify how your guest compares to others in their field.
- **Audience question integration** - Automatically incorporate listener questions into the interview prep.
- **Post-interview insights** - Auto-generate show notes, transcript summaries, and audience takeaways.
- **Native integrations** - Direct integration with popular podcast hosting platforms.
...
A: Yes. New users receive complimentary research sessions, giving you the chance to evaluate the platform with real guests before committing to a subscription.

**Q: What are the pricing plans?**

A: We offer flexible pricing for solo podcasters, small networks, and enterprise users. Visit our pricing page for details, or contact our team for custom enterprise arrangements.

**Q: Do you offer API access for production companies?**

A: Absolutely. We provide a streaming API for podcast networks and production companies who want to integrate guest research directly into their production workflows. Contact sales to discuss API access and custom integration support.
...
- **Time savings** - Average research time reduction per guest interview.
- **User retention** - Percentage of users who return for multiple research sessions.
- **Interview quality** - Host satisfaction with the quality and relevance of generated preparation materials.
- **Guest reach** - How often hosts discover new or underexplored aspects of their guests' backgrounds.
- **Audience engagement** - Whether AI-assisted preparation correlates with higher listener engagement and retention.
